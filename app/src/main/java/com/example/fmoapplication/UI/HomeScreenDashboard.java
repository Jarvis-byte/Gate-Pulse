...
import com.example.fmoapplication.ViewModel.TempViewModel;
...
public class HomeScreenDashboard extends AppCompatActivity {
    ...
    private TempViewModel weatherViewModel;
    boolean isfetchedTemp = false;
                    ...
                    for (Location location : locationResult.getLocations()) {
                        if (location != null) {
                            ...
                            try {
                                ...
                                if (weatherViewModel.getTemperatureLiveData().getValue() == null) {
                                    // If not, fetch the weather data
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        isfetchedTemp = true;
                        // Set the temperature in the ViewModel
