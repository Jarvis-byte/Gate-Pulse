                ...
                dialogView.findViewById(R.id.btnReset).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (TextUtils.isEmpty(userEmail) && !Patterns.EMAIL_ADDRESS.matcher(userEmail).matches()) {
                            ...
                            Toast.makeText(HomeScreenDashboard.this, "Enter your Admin PIN", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        db.collection("Pin").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                ...
                                if (!queryDocumentSnapshots.isEmpty()) {
                                    ...
                                    for (DocumentSnapshot d : list) {
                                        ...
                                        if (pin.getAuthCode().equals(enterpin)) {
                                            ...
                                            aLodingDialog.cancel();
                                            emailBox.setText("");
                                            Toast.makeText(HomeScreenDashboard.this, "Wrong Pin!!! Please enter correct PIN", Toast.LENGTH_SHORT).show();
                                        }
                            ...
                            public void onFailure(@NonNull Exception e) {
                                aLodingDialog.cancel();
                                Toast.makeText(HomeScreenDashboard.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
